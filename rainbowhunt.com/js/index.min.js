      ...
      function (t, e, i) {
        ...
        function n() {
          (0, y["default"])([
            ...
            { name: "textureRainFg", src: "img/weather/texture-sun-2fg.png" },
            { name: "textureRainBg", src: "img/weather/texture-sun-2bg.jpg" },
            {
              name: "textureStormLightningFg",
              src: "img/weather/texture-sun-2fg.png",
            },
            {
              name: "textureStormLightningBg",
              src: "img/weather/texture-sun-2bg.jpg",
            },
            {
            ...
            },
            {
              ...
              src: "img/weather/texture-fallout-bg.jpg",
            },
            { name: "textureSunFg", src: "img/weather/texture-sun-fg.png" },
            { name: "textureSunBg", src: "img/weather/texture-sun-bg.jpg" },
            { name: "textureSun2Fg", src: "img/weather/texture-sun-2fg.png" },
            { name: "textureSun2Bg", src: "img/weather/texture-sun-2bg.jpg" },
            {
